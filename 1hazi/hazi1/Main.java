public class Main {
    ...
    static String bothEnds(String s)
    {
        ...
        String sNew = s.substring(0, 2) + s.substring(n-2);
        return sNew;
    }
    ...
    static String fixStart(String s) {
        char puki = s.charAt(0);
        return puki + s.substring(1).replace(puki, '*');
    }
    ...
    static String mixUp(String a, String b) {
        ...
        a = String.valueOf(aNew);
        b = String.valueOf(bNew);
